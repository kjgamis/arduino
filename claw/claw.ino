...
#define CLAW_CLOSE 175
#define BASE_MIN 0
#define BASE_MAX 180
#define HORIZONTAL_MIN 90
#define HORIZONTAL_MAX 180

#define VERTICAL_MIN 20
#define VERTICAL_MAX 160
...
Servo_info servos [] = {
  {base,       5,  BASE_MIN, BASE_MAX, LEFT_JS_H},
  {horizontal, 9, HORIZONTAL_MIN, HORIZONTAL_MAX, LEFT_JS_V},
  {vertical,  10, VERTICAL_MIN, VERTICAL_MAX, RIGHT_JS_V},
  {claw,      11, CLAW_OPEN, CLAW_CLOSE, RIGHT_JS_H}  
};
