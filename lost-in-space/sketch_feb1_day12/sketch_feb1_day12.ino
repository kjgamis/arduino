...
Keypad myHeroPad = Keypad(makeKeymap(BUTTONS), ROW_PINS, COL_PINS, ROWS, COLS);
...
const unsigned int TONES[ROWS][COLS] = {
  ...
  { 392, 440, 493, 523 },
  { 587, 659, 698, 783 },
  { 880, 987, 1046, 0 }  // Use frequency of 0 for bottom right key to end tone.
};
...
void loop() {
  char button_character = myHeroPad.waitForKey();  // Wait for a button to be pressed
