...
const int regularTone = 800;
const int successTone = 1200;
const int errorTone = 600;
  ...
  if (button_character == '*') {  // button to change PIN
    ...
    if (access_allowed) {
      ...
      for (int i = 0; i < PIN_LENGTH; i++) {
        ...
        tone(BUZZER_PIN, regularTone, 200);
